...
However, each of these plays a crucial part in pushing the product and company forward. I previously wrote about best practices for creating a PR [here](https://annanay.dev/contributing-to-open-source/), check that out if you are interested.
